      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-6 font-mono text-sm sm:text-base">
          <div className="space-y-2">
            <p>Total Working {calculation.totalDays} Days = Rs. {calculation.totalDays * dailyRate}</p>
            <p>Double Shift {calculation.doubleDays} Days = + Rs. {calculation.doubleDays * dailyRate}</p>
          ...
          <div className="mt-6 space-y-2">
            ...
            <p>Absent + Holiday {calculation.absentDays + calculation.holidayDays} Days = - Rs. {(calculation.absentDays + calculation.holidayDays) * dailyRate}</p>
            <div className="border-t border-gray-200 dark:border-gray-700 my-2"></div>
            <p className="font-semibold">Net Salary = Rs. {calculation.netSalary}</p>
          </div>
        </div>
